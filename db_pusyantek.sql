...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2020 at 05:21 PM
...
('1010301001000027', '000027', 'Stabilo Boss', 1010301001, 5, '2020-09-06 20:35:26', NULL),
...
--
ALTER TABLE `insert`
  MODIFY `insert_id` int(100) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transaksi`
  MODIFY `transaksi_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
