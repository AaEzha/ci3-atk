                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            ?> <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url("transaksi/delete_cart/{$items['rowid']}") ?>" class="btn btn-danger btn-sm">
                            ...
                            <tr>
                                ...
                                <th>
                                    <a href="javascript:;" onclick="checkOut()" class="btn btn-success btn-flat">Simpan</a>
                                    <a href="<?php echo site_url('transaksi/cancel') ?>" class="btn btn-danger btn-flat">Cancel</a>
                                </th>
                            </tr>
                        </tbody>
                    </table>
